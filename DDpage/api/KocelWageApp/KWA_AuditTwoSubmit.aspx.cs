...
{
    public partial class KWA_AuditTwoSubmit : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (sdr01.HasRows)
            {
                ...
                //写入审批表
                strSql = " update [DDdatabase].[dbo].[Tab_KWA_AuditList] set ThRemark='" + strOpinion + "',ThTime='" + DateTime.Now.ToString() + "',stat='3' ";
