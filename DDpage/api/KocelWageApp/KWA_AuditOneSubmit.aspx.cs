...
{
    public partial class KWA_AuditOneSubmit : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (sdr01.HasRows)
            {
                ...
                //写入审批表
                strSql = " update [DDdatabase].[dbo].[Tab_KWA_AuditList] set TwoRemark='"+strOpinion+"',TwoTime='"+DateTime.Now.ToString()+"',ThCompany='"+ strThCompany + "',ThDept='"+ strThDept + "',ThName='"+strThName+"',stat='2' ";
                ...
                //返回json数据
                strJson = "{\"stat\":\"" + stat + "\",\"err\":\"" + strMsg + "\",\"rid\":\"" + strRID + "\",\"id\":\"" + strId + "\",\"name\":\"" + strThName + "\",\"phone\":\"" + strThPhone + "\"}";
