...
{
    public partial class checkListUpdate_sumbit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            foreach (JObject jObject in jsonObj)
            {
                ...
                if (oneNum > 0)
                {
                    InsidePlanWaitSap(oneNum, strCheckId, strCostCode, strSapVenCode, strPersonCode);
                    //InsidePlanSap(oneNum, strCheckId, strCostCode, strSapVenCode, strPersonCode);
                }
                //计划外领料函数调用
                if (twoNum > 0)
                {
                    OutsidePlanWaitSap(twoNum, strCheckId, strCostCode, strSapVenCode, strPersonCode);
                    //OutsidePlanSap(twoNum, strCheckId, strCostCode, strSapVenCode, strPersonCode);
                }
                //成本中心领料函数调用
                if (thNum > 0)
                {
                    CostCenterWaitSap(thNum, strCheckId, strCostCode, strSapVenCode, strPersonCode);
        ...
        public void InsidePlanWaitSap(int strNum, string strCheckId, string strCostCode, string strVenCode, string strPersonCode)
        {
            SqlConnection con = new SqlConnection("Data Source=192.168.0.186;Initial Catalog=DataFromSap;User ID=tide;Password=lan@2mail");
            con.Open();
            ...
            if (sdrJsonDetail.HasRows)
            {
                while (sdrJsonDetail.Read())
                {
                    ...
                    string strOddNo = sdrJsonDetail[0].ToString();
                    string strSapVenture = sdrJsonDetail[1].ToString();
                    string strVornor = sdrJsonDetail[2].ToString();
                    string strMCode = sdrJsonDetail[3].ToString();
                    string strMStockCode = sdrJsonDetail[4].ToString();
                    string strMInventory = sdrJsonDetail[5].ToString();
                    ...
                    strSql = "insert into  [DDdatabase].[dbo].[Tab_KocelApp_Kmr_WaitSapRecord]([ID],[PType] ,[PItemType] ,[PDID],[oddNo] ,[CostCenter],[SapVenture] ,[MStockCode],[MCode] ,[PNum],[Vornor]  ,[personCode] ,[inputTime],[ifSap])";
                    strSql += " values('" + System.Guid.NewGuid().ToString() + "','跨公司领料','计划内领料','" + strCheckId + "','" + strOddNo + "','" + strCostCode + "','" + strSapVenture + "','" + strMStockCode + "','" + strMCode + "','" + strMInventory + "','" + strVornor + "','" + strPersonCode + "','" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "','0')";

                    SqlCommand cmdWaitSap = new SqlCommand(strSql, conNew);
                    int t1 = cmdWaitSap.ExecuteNonQuery();
                }
            }
        ...
        public void OutsidePlanWaitSap(int strNum, string strCheckId, string strCostCode, string strVenCode, string strPersonCode)
        {
            SqlConnection con = new SqlConnection("Data Source=192.168.0.186;Initial Catalog=DataFromSap;User ID=tide;Password=lan@2mail");
            con.Open();
            SqlConnection conNew = new SqlConnection("Data Source=192.168.0.186;Initial Catalog=DataFromSap;User ID=tide;Password=lan@2mail");
            ...
            if (sdrJsonDetail.HasRows)
            {
                while (sdrJsonDetail.Read())
                {
                    ...
                    strSql = "insert into  [DDdatabase].[dbo].[Tab_KocelApp_Kmr_WaitSapRecord]([ID],[PType] ,[PItemType] ,[PDID],[oddNo] ,[CostCenter],[SapVenture],[FCompanyCode],[MStockCode],[MCode] ,[PNum],[Vornor]  ,[personCode] ,[inputTime],[ifSap])";
                    strSql += " values('" + System.Guid.NewGuid().ToString() + "','跨公司领料','计划外领料','" + strCheckId + "','" + strOddNo + "','" + strCostCode + "','" + strSapVenture + "','"+ strComCode + "','" + strMStockCode + "','" + strMCode + "','" + strMInventory + "','" + strVornor + "','" + strPersonCode + "','" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "','0')";
        ...
        public void CostCenterWaitSap(int strNum, string strCheckId, string strCostCode, string strVenCode, string strPersonCode)
        {
            ...
            if (sdrJsonDetail.HasRows)
            {
                while (sdrJsonDetail.Read())
                {
                    ...
                    sdrwerk.Close();
                    //sap预留接口调用
                    string strMCode = sdrJsonDetail[0].ToString();
                    string strMInventory = sdrJsonDetail[1].ToString();
                    string strMUnit = sdrJsonDetail[2].ToString();
                    string strMStockCode = sdrJsonDetail[7].ToString();
                    string strMBatch = sdrJsonDetail[4].ToString();
                    
                    
                    strSql = "insert into  [DDdatabase].[dbo].[Tab_KocelApp_Kmr_WaitSapRecord]([ID],[PType] ,[PItemType] ,[PDID] ,[CostCenter],[SapVenture],[MFactoryCode],[MStockCode],[MCode] ,[PNum]  ,[personCode] ,[inputTime],[ifSap])";
                    strSql += " values('" + System.Guid.NewGuid().ToString() + "','跨公司领料','成本中心领料','" + strCheckId + "','" + strCostCode + "','" + strVenCode + "','"+ werksCode + "','" + strMStockCode + "','" + strMCode + "','" + strMInventory + "','" + strPersonCode + "','" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "','0')";
