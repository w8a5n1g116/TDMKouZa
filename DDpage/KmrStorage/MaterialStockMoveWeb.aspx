<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialStockMoveWeb.aspx.cs" Inherits="DDpage.KmrStorage.MaterialStockMoveWeb" %>
    ...
    <div class="mui-content">
        <div class="mui-slider-group">
            <div id="item1mobile" class="mui-slider-item mui-control-content mui-active">
                <div id="scroll1" class="mui-scroll-wrapper" style="position: static">
                    <div class="mui-scroll" style="position: static">
...
<script type="text/javascript">
    ...
    $(function () {
        $("#save_change").click(function () {
            ...
            $.post("MaterialStockMoveSql.aspx", { Code: strMatreialCode, kcdd: kcdd, phone: _phone }, function (fd) {
                if(fd == "True")
                {
                    alert("操作成功！");
                }
