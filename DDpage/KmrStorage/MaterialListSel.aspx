<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialListSel.aspx.cs" Inherits="DDpage.KmrStorage.MaterialListSel" %>
...
<body>
    ...
    <script>
        ...
        function checkdetail_click(obj) {
            var key = $(obj).attr("id");
            location.href = "MaterialStockInfo.aspx?code=" + key;
        }
