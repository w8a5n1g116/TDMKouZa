<%@ Page Language="C#"  AutoEventWireup="true" CodeBehind="checkIn_tablist1900_submit.aspx.cs" Inherits="DDpage.KmrStorage.checkIn_tablist1900_submit" %>
                        ...
                        /*.mui-icon-extra
{
    ...
    <script>
        ...
        function getFList(ob) {
            ...
            ajaxUrl = "../api/KmrStorage/GetPurchaseInfo1900.aspx";
            mui.ajax(ajaxUrl, {
                data: { },
                async: true,
                crossDomain: true,
        ...
        function postData() {
            ...
            $.post("../api/KmrStorage/checkInList_sumbit1900.aspx",
                { PCompany: _company, PDept: _dept, PVenture: _venture, PName: _name, PCode: _cardId, PTime: getNowFormatDate(), CarNo: carno, CarPhone: carphone, dataList: strJson },
