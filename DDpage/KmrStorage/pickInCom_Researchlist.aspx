<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pickInCom_Researchlist.aspx.cs" Inherits="DDpage.KmrStorage.pickInCom_Researchlist" %>
...
14         text-align: left;
    ...
    <script>
        ...
        function getFiveList() {
            ...
            mui.ajax(ajaxUrl, {
                data: { comName: _company, matName: strMatName, stockCode: _stockCode, stockName: strStockName, dataNum: strdataNum },
                async: false,
                crossDomain: true,
                type: 'post',//HTTP请求类型
                success: function (data) {
        ...
        function postData() {
            ...
            $.post("../api/KmrStorage/pickTabList_sumbit_BL.aspx",
                { PCompany: _company, PDept: _dept, PVenture: _venture, SapVenId: _venSapId, PName: _name, PCode: _cardId, PCostCode: _costCode, OddNo: orderNum, ProNo: '', dataListOne: strOneJson, dataListTwo: strTwoJson, dataListTh: strThJson, dataListFour: strFourJson, OneNum: oneNum, TwoNum: twoNum, ThNum: thNum, FourNum: fourNum },
