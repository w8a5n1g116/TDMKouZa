<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pickOutCom_InPlanlist.aspx.cs" Inherits="DDpage.KmrStorage.pickOutCom_InPlanlist" %>
    ...
    <script>
        ...
        function postData() {
            ...
            $.post("../api/KmrStorage/sapList_sumbit.aspx",
                { PCompany: _company, PDept: _dept, PVenture: _venture, sapVentureCode: _sapVenId, PName: _name, PCode: _cardId, PTime: getNowFormatDate(), OddNo: orderNum, ProNo: proNum, PStNo: pStCode, PickStat: "1", dataListOne: strOneJson},
