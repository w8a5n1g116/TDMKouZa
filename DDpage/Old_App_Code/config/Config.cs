...
public static class Config
{
    ...
    {
        get { return Config._AppKey; }
        set { Config._AppKey = value; }
    }

    public static string AppSecret
    {
        get { return Config._AppSecret; }
        set { Config._AppSecret = value; }
    }
    ...
    static Config()
    {
        ...
        _AppKey = ConfigurationManager.AppSettings[ConfigurationKeys.AppKey];
        _AppSecret = ConfigurationManager.AppSettings[ConfigurationKeys.AppSecret];
    }
    ...
    private static class ConfigurationKeys
    {
        ...
        public const string AppKey = "E.AppKey";
        public const string AppSecret = "E.AppSecret";
    }
}